...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "STEM Universidad Estudiantes";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "estudiante";
process.env.TABLE_NAME = process.env.TABLE_NAME || "estudiante_records";
'use strict';
